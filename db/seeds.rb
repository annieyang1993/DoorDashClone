...
# Item.find_by(item_name: 'Grapefruit Green Tea').delete
# Item.find_by(item_name: 'Pineapple Green Tea').delete
# Item.find_by(item_name: 'Supreme Fruit Tea Slush with Cheese Cream').delete
# Item.find_by(item_name: 'Yakult Lemon Slush').delete
